...
function addMarker(place) {
    //extrar la latitud y longitud del lugar
    ...
    $.getJSON(Flask.url_for("articles"), { geo: place.postal_code }, function(articles) {
        ...
        // esta funcion mostrara la ventana de informacion si hay ariticulos
        ...
        //se crea una lista para clicks en market
        google.maps.event.addListener(marker, 'click', function() {
            showInfo(marker, articlescontent);
        });
    });

    //se anade en el mapa los markerts
    markers.push(marker);
